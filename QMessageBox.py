...
class QMessageboxdemo(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle("QMassagebox演示")
        self.resize(300,400)
    ...
    def showDialog(self):
        ...
        if  text == '显示关于对话框':
            ...
            reply = QMessageBox.information(self, '消息', '这是一个消息对话框', QMessageBox.Yes | QMessageBox.No, QMessageBox.Yes)  # 默认yes
            ...
            QMessageBox.question(self, '请问', '这是一个请问对话框', QMessageBox.Yes | QMessageBox.No, QMessageBox.Yes)
